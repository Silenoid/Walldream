package com.silenoids.walldream.helper;
...
public class ObjectFactory {
    ...
    public void initialize(Context context) throws IllegalStateException {
        if(instance == null) {
            throw new IllegalStateException("Tentata inizializzazione prima della iniziale istanziazione del Singleton");
        }
    ...
    public String readRawResource(int id) {
        ...
        try(BufferedReader reader = new BufferedReader(new InputStreamReader(inputStream))){
            contentChunk = reader.readLine();
            while (contentChunk != null) {
                lineBuilder.append(contentChunk).append("\n");
                contentChunk = reader.readLine();
            }
        } catch (IOException e) {
